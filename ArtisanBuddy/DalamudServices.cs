...
public class Svc
{
    ...
    [PluginService]
    public static IBuddyList Buddies { get; private set; }
    ...
    [PluginService]
    public static IFateTable Fates { get; private set; }
    ...
    [PluginService]
    public static IPartyFinderGui PfGui { get; private set; }

    [PluginService]
    public static IPartyList Party { get; private set; }
    ...
    [PluginService]
    public static IToastGui Toasts { get; private set; }
    ...
    [PluginService]
    public static ITextureProvider Texture { get; private set; }
    ...
    [PluginService]
    public static ITextureSubstitutionProvider TextureSubstitution { get; private set; }
